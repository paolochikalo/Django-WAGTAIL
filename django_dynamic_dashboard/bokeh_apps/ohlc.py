...
def ohlc_stream(doc: Document) -> None:
    ...
    p.line(x='time', y='average', alpha=0.2, line_width=5, color='navy', source=source)
    ...
    doc.add_root(column(row(mean, stddev, mavg), gridplot([[p], [p2]], toolbar_location="left", plot_width=1700)))
